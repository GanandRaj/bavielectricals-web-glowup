    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className={cn(
            "bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 opacity-0",
          ...
          <div className={cn(
            "grid grid-cols-1 sm:grid-cols-2 gap-6 opacity-0",
            ...
            {features.map((feature, index) => (
              <div 
                key={index} 
                className={cn(
                  "text-center p-8 bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/30 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 opacity-0",
